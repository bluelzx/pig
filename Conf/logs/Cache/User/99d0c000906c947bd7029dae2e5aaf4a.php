...
<?php if($fuwu == TRUE): ?><tr><td align="right">网关（服务窗）</td><td><input class="px" value="<?php echo C('site_url'); echo U('Fuwu/Fuwu/api',array('token'=>$info['token']));?>" style="width:550px;height:30px;" /> <input id="copy-button4" data-clipboard-text="<?php echo C('site_url'); echo U('Fuwu/Fuwu/api',array('token'=>$info['token']));?>" class="btn btn-sm btn-default" value="复制" type="button"></td></tr>
