...
<?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?><tr><td><?php echo ($m["name"]); ?></td><td class="norightborder"><a href="###" onclick="returnHomepage(<?php echo ($m["id"]); ?>,'<?php echo ($m["name"]); ?>','<?php echo ($m["pic"]); ?>','<?php echo ($m["info"]); ?>')">选中</a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
<?php else: ?>
<tr><td colspan="2" align="center"><a href="<?php echo U('Img/add');?>" target="_blank" style="color:#369">还没有图文消息，请点击这里添加图文消息</a></td></tr><?php endif; ?>
</table>
