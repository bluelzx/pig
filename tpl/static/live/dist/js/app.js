define("dist/js/app", ["./zepto","./touch","./global","./page","./media","./image","./event","./sileFn","./map","./ylMap","./form","./plugins","./ylMusic","./fx","./weixin","./Lottery"], function (require, exports, module) {
    ...
    var i = function () {
        ...
        return V.matches = function (t, e) {
            ...
            var i;
            if (!t) return V.Z();
            if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && A.test(t)) i = V.fragment(t, RegExp.$1, n), t = null;
            else {
            ...
            var n, i, a, o = [];
            if (r(t)) for (i = 0; t.length > i; i++) n = e(t[i], i), null != n && o.push(n);
            else for (a in t) n = e(t[a], a), null != n && o.push(n);
            return l(o)
        }, C.each = function (t, e) {
            var n, i;
            if (r(t)) {
    ...
    var e = t("./zepto"),
        ...
        i = {
            ...
            _IsPC: function () {
                for (var t = navigator.userAgent, e = ["Android", "iPhone", "SymbianOS", "Windows Phone", "iPad", "iPod"], n = !0, i = 0; e.length > i; i++) if (t.indexOf(e[i]) > 0) {
                    n = !1;
                    break
                }
                return n
            ...
            _injectStyles: function (t, e, n, i) {
                var a, o, r, s, l = document.createElement("div"),
                    ...
                    h = "modernizr";
                if (parseInt(n, 10)) for (; n--;) r = document.createElement("div"), r.id = i ? i[n] : h + (n + 1), l.appendChild(r);
        ...
        r = {
            ...
            wxShare: function () {
                e("body").on("click", ".bigTxt-btn-wx", function () {
                    var t = e(this).parent().parent().find(".bigTxt-weixin");
    ...
    var n = t("./Lottery"),
        ...
        r = {
            init: function () {
                ...
                if (1 == n) {
                    var a = e("#j-mengban")[0],
                        s = "./tpl/static/live/images/page_01_bg@2x.jpg",
                        l = e("#r-cover").val(),
                        c = "image",
                        u = 640,
                        h = e(window).height(),
    ...
    a = t("./fx"), n.exports = a, function (t) {
        t.fn.coffee = function (e) {
            ...
            steams: ["jQuery", "HTML5", "HTML6", "CSS2", "CSS3", "JS", "$.fn()", "char", "short", "if", "float", "else", "type", "case", "function", "travel", "return", "array()", "empty()", "eval", "C++", "JAVA", "PHP", "JSP", ".NET", "while", "this", "$.find();", "float", "$.ajax()", "addClass", "width", "height", "Click", "each", "animate", "cookie", "bug", "Design", "Julying", "$(this)", "i++", "Chrome", "Firefox", "Firebug", "IE6", "Guitar", "Music"],
                        ...
                        timeline: function (t, e) {
                            n(function () {
                                WeixinJSBridge.on("menu:share:timeline", function () {
                                    WeixinJSBridge.invoke("shareTimeline", t, function (resp) {
                                        if (resp.err_msg == 'share_timeline:confirm' || resp.err_msg == 'share_timeline:ok') {
                                            $.get($("#r-wx-share").val(), {}, function () {});
                                        }
                                    })
                                })
                            })
                        ...
                        message: function (t, e) {
                            n(function () {
                                WeixinJSBridge.on("menu:share:appmessage", function () {
                                    WeixinJSBridge.invoke("sendAppMessage", t, function (resp) {
